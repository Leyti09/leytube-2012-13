     ...
     crossorigin="anonymous">
      ...
      <script>
		...
		<?php
			...
			$_user2 = $__user_h->fetch_user_username($_video['author']);
						...
						<div id="watch-headline-container">
							<div id="watch-headline" class="watch-headline">
								...
								<div id="watch-headline-user-info">
									<button style="margin-right: -5px;" href="<?php if($_user2['vanity'])	{	?><?php echo htmlspecialchars($_user2['vanity']); ?><?php } else{ ?>/user/<?php echo htmlspecialchars($_user2['username']); ?><?php } ?>" type="button" class="start yt-uix-button yt-uix-button-default" onclick=";window.location.href=this.getAttribute('href');return false;" role="button">
										<span class="yt-uix-button-content">											
											<?php if($_user2['title'])	{	?>
											<?php echo htmlspecialchars($_user2['title']); ?>
											<?php } else {	?>
											<?php echo htmlspecialchars($_user2['username']); ?>
											<?php	}	?></span>
									</button>
									<?php if(@$_SESSION['siteusername'] !== $_video['author']) { ?>
...
if (window.yt.timing) {yt.timing.tick("bf");}    </script>
							...
							<div id="watch-main">
								<div id="watch-panel">
									<?php if($_video['featured'] == "v") { ?>
										...
										<div class="yt-alert-buttons"></div><div class="yt-alert-content" role="alert">    <span class="yt-alert-vertical-trick"></span>
											<div class="yt-alert-message">
												This video is featured. View more featured videos by Betatube on the homepage.
											</div>
										</div></div></div>
									<?php }  ?>
										...
										<div id="watch-actions-area" class="yt-rounded">
											<div id="watch-actions-loading" class="watch-actions-panel hid">
												<div class="comments-disabled-message">
													<span>Analytics are not available for any video on this site.</span>
												</div>
											</div>
													...
													<div class="share-panel">
														<div class="share-option-container ytg-box">
															<div class="share-panel-url-container">
																<span class=" yt-uix-form-input-container "><input class="yt-uix-form-input-text share-panel-url" name="share_url" value="https://betatube.net/watch?v=<?php echo $_video['rid']; ?>" data-video-id="<?php echo $_video['rid']; ?>"></span>
															...
															<div class="share-panel-embed-container" style="">
																<textarea class="yt-uix-form-textarea share-embed-code" onkeydown="if ((event.ctrlKey || event.metaKey) &amp;&amp; event.keyCode == 67) { yt.tracking.track('embedCodeCopied'); }"><iframe width="560" height="315" src="https://betatube.net/watch?v=<?php echo $_GET['v'] ?>" title="BetaTube embed player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></textarea>
										...
										<div id="watch-description" class="yt-uix-expander  yt-uix-expander-collapsed" data-expander-action="yt.www.watch.watch5.handleToggleDescription">
											<div id="watch-description-clip">
												<p id="watch-uploader-info">
													Published on <span id="eow-date" class="watch-video-date"><?php echo date("M d, Y", strtotime($_video['publish'])); ?></span> by     <a href="<?php if($_user2['vanity'])	{	?>/<?php echo htmlspecialchars($_user2['vanity']); ?><?php } else{ ?>/user/<?php echo htmlspecialchars($_user2['username']); ?><?php } ?>" class="yt-uix-sessionlink yt-user-name author" rel="author" data-sessionlink="<?php echo htmlspecialchars($_video['author']); ?>" dir="ltr">											<?php if($_user2['title'])	{	?>
											<?php echo htmlspecialchars($_user2['title']); ?>
											<?php } else {	?>
											<?php echo htmlspecialchars($_user2['username']); ?>
											<?php	}	?></a>
											...
											<div id="comment-share-area" class="comment-share-area yt-rounded hid">
												<div class="comment-share-content">
													...
													<div style="visibility: hidden;">
														<input type="text" value="betatube.net/watch?v=<?php echo $_GET['v']; ?>" class="comment-share-url yt-uix-form-input-text">
													</div>
													<div>
														<input type="text" value="betatube.net/watch?v=<?php echo $_GET['v']; ?>" class="yt-uix-form-input-text">
													</div>
											...
											<div class="comments-section " onmouseover="if (yt.www &amp;&amp; yt.www.watch &amp;&amp; yt.www.watch.livecomments) yt.www.watch.livecomments.handleCommentMouseEvent(this, event);" onmouseout="if (yt.www &amp;&amp; yt.www.watch &amp;&amp; yt.www.watch.livecomments) yt.www.watch.livecomments.handleCommentMouseEvent(this, event);">
												...
												<ul class="comment-list" id="live_comments">
														...
														while($comment = $stmt->fetch(PDO::FETCH_ASSOC)) { 
															...
															$_user2 = $__user_h->fetch_user_username($comment['author']);
															...
															<div class="comment-body">
																<div class="content-container">
																	<div class="content">
																		...
																		<p class="metadata">
																			<span class="author ">
																			<a href="<?php if($_user2['vanity'])	{	?>/<?php echo htmlspecialchars($_user2['vanity']); ?><?php } else{ ?>/user/<?php echo htmlspecialchars($comment['author']); ?><?php } ?>" class="yt-uix-sessionlink yt-user-name " data-sessionlink="<?php echo htmlspecialchars($comment['author']); ?>" dir="ltr">
	<?php if($_user2['title'])	{	?>
	<?php echo htmlspecialchars($_user2['title']); ?>
	<?php } else {	?>
	<?php echo htmlspecialchars($_user2['username']); ?>
	<?php	}	?></a>
														...
														<?php 
															...
															$_user2 = $__user_h->fetch_user_username($reply['author']);
														?>
																...
																<div class="comment-body">
																	<div class="content-container">
																		<div class="content">
																			...
																			<p class="metadata">
																				<span class="author ">
																				<a href="<?php if($_user2['vanity'])	{	?>/<?php echo htmlspecialchars($_user2['vanity']); ?><?php } else{ ?>/user/<?php echo htmlspecialchars($reply['author']); ?><?php } ?>" class="yt-uix-sessionlink yt-user-name " data-sessionlink="<?php echo htmlspecialchars($reply['author']); ?>" dir="ltr">
	<?php if($_user2['title'])	{	?>
	<?php echo htmlspecialchars($_user2['title']); ?>
	<?php } else {	?>
	<?php echo htmlspecialchars($_user2['username']); ?>
