...
?>
<?php    if($_user['channelversion'] == 'cosmic') { ?>
				...
				<div id="watch-owner-container">
					<div id="masthead-subnav" class="yt-nav yt-nav-dark ">
							<ul class="yt-nav-aside">
									<li>
										<a href="https://betatube.net/my_videos" class="yt-uix-button yt-uix-sessionlink yt-uix-button-subnav  yt-uix-button-dark" data-sessionlink="ei=CMCA1_3robMCFSrJRAodqnnxKQ%3D%3D"><span class="yt-uix-button-content">see my video</span></a>
									</li>
							</ul>
							<ul>
									<li>
										<a href="/account" class="yt-uix-button yt-uix-sessionlink yt-uix-button-subnav  yt-uix-button-dark" data-sessionlink="ei=CMCA1_3robMCFSrJRAodqnnxKQ%3D%3D"><span class="yt-uix-button-content">change channel stuffs</span></a>
									</li>
							</ul>
					</div>
				</div>
				<?php	}	?>
				<center><img src="/tracle.png" style="width: 970px;height: 100px;"></center>
				<!-- begin content -->
				<?php
					if(empty(trim($_user['bio'])))
						$_user['bio'] = "dis person lazyy and did not tel u da bio";
				?>
				<div id="content">
					...
					<div id="branded-page-default-bg" class="ytg-base">
						<div id="branded-page-body-container" class="ytg-base clearfix">
									...
									<div id="channel-header-main">
										<div class="upper-section clearfix">
												...
												<?php if($_user['username'] != @$_SESSION['siteusername']) { ?>
													<div class="yt-subscription-button-hovercard yt-uix-hovercard">
														<button 
															...
															src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt=""></span><span class="yt-uix-button-content">  <span class="subscribe-label">make sub</span>
														<span class="subscribed-label">already subbed u dumb</span>
														<span class="unsubscribe-label">make me not sub</span>
														</span></button>
											...
											<?php	}	?>
												<?php if($__user_h->if_partner($_user['username'])) { ?>
													<img style="width: 29px;vertical-align: middle;margin-left: 10px;" title="This user is a partner!" src="/tracle.png">
												<?php } ?>
											...
											<div class="upper-right-section">
												<div class="header-stats">
													<div class="stat-entry">
														...
														<span class="stat-name">sub on ma channel</span>
													</div>
													<div class="stat-entry">
														<span class="stat-value"><?php echo $_user['views']; ?></span>
														<span class="stat-name">view video</span>
													</div>
												</div>
										...
										<div class="channel-horizontal-menu clearfix">
											<ul>
												...
												<li>
													<a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="gh-tab-101">
													ur mom
													</a>
												</li>
											</ul>
											<form id="channel-search" action="/user/<?php echo htmlspecialchars($_user['username']); ?>/videos">
												<input name="query" type="text" maxlength="100" class="search-field" placeholder="i 2 lazy 2 look so i search" value="">
							...
							<div id="branded-page-body">
								<?php require($_SERVER['DOCUMENT_ROOT'] . "/s/mod/channel_april1.php"); ?>
							</div>
						</div>
					</div>
				</div>
  ...
  yt.setMsg('QUICKTIME_FALLBACK', "\u003cdiv class=\"yt-alert yt-alert-default yt-alert-error  yt-alert-player\"\u003e  \u003cdiv class=\"yt-alert-icon\"\u003e\n    \u003cimg s\u0072c=\"\/\/s.ytimg.com\/yt\/img\/pixel-vfl3z5WfW.gif\" class=\"icon master-sprite\" alt=\"Alert icon\"\u003e\n  \u003c\/div\u003e\n\u003cdiv class=\"yt-alert-buttons\"\u003e\u003c\/div\u003e\u003cdiv class=\"yt-alert-content\" role=\"alert\"\u003e    \u003cspan class=\"yt-alert-vertical-trick\"\u003e\u003c\/span\u003e\n    \u003cdiv class=\"yt-alert-message\"\u003e\n            The Adobe Flash Player or QuickTime is required for video playback. \u003cbr\u003e \u003ca href=\"\/\/get.adobe.com\/flashplayer\/\"\u003eGet the latest Flash Player\u003c\/a\u003e \u003cbr\u003e \u003ca href=\"\/\/www.apple.com\/quicktime\/download\/\"\u003eGet the latest version of QuickTime\u003c\/a\u003e\n    \u003c\/div\u003e\n\u003c\/div\u003e\u003c\/div\u003e");
    ...
    (function() {
      ...
      yt.setConfig({'PLAYER_REFERENCE': youTubePlayer});
		...
		<?php	} else{	?>
			<?php	if ($_user['channelversion'] == '20') {	?>
				<?php require($_SERVER['DOCUMENT_ROOT'] . "/channel_200.php"); ?>
			<?php	} else{	?>
				<?php require($_SERVER['DOCUMENT_ROOT'] . "/s/mod/2013_channel.php"); ?>
			<?php	}	?>
		<?php	}	?>
	</body>
</html>
