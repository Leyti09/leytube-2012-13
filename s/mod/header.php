...
?>
<!-- begin masthead -->
<div id="ticker" class="ytg-base "><div id="ticker-inner"><div class="ytg-wide"><button onclick="yt.net.cookies.set('HideTicker', 1, 604800);" class="yt-uix-close" data-close-parent-id="ticker"><img alt="Close" src="https://web.archive.org/web/20220217230703im_/https://s.ytimg.com/yts/img/pixel-vfl3z5WfW.gif"></button><img class="ticker-icon" src="https://web.archive.org/web/20220217230703im_/https://s.ytimg.com/yts/img/pixel-vfl3z5WfW.gif" alt=""><div class="ticker-content">
		<b>LeyTube is here!<pre style="display:inline-block;"></pre></b> <pre style="display:inline-block;font-size:10px;margin-left:35px;">You can upload new videos on 2012 YT</pre>
	</div></div></div></div>
