...
<?php $playlist = getPlaylistFromID($_GET['id'], $conn); ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="branded-page-v2-container  branded-page-v2-secondary-column-hidden">
                    ...
                    <?php
                        ...
                        while($row = $result->fetch_assoc()) { 
                            ...
                            ?> 
                                <!-- VIDEO START -->
                                <li class="video-list-item related-list-item"><a href="/watch?v=<?php echo $row['rid']; ?>&playlist=<?php echo $_GET['id']; ?>&order=<?php echo $id; ?>" class="related-video yt-uix-contextlink  yt-uix-sessionlink" data-sessionlink="feature=related&amp;ei=n-PiUdfCIcfckwLEyoDACw&amp;ved=CAMQzRooAA"><span class="ux-thumb-wrap contains-addto ">    <span class="video-thumb  yt-thumb yt-thumb-120">
