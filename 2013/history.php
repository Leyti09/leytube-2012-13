    ...
    <div id="page-container">
        <div id="page" class="  home  clearfix"><div id="guide">        <div id="guide-container" class="">
                ...
                <div class="branded-page-v2-container  branded-page-v2-secondary-column-hidden">
                    ...
                    <?php
                        $stmt = $conn->prepare("SELECT * FROM `history` WHERE author = ? ORDER BY id DESC");
                        $stmt->bind_param('s', $_SESSION['siteusername']);
                        
                        $stmt->execute();
                        $result = $stmt->get_result();
                    echo $result->num_rows . " results(s)<br><br>";
                        while($row = $result->fetch_assoc()) { ?> 
                        <?php $video = getVideoFromId($row['video'], $conn); ?>
                        <!-- VIDEO START -->
                        <li class="video-list-item related-list-item"><a href="/watch?v=<?php echo $video['rid']; ?>" class="related-video yt-uix-contextlink  yt-uix-sessionlink" data-sessionlink="feature=related&amp;ei=n-PiUdfCIcfckwLEyoDACw&amp;ved=CAMQzRooAA"><span class="ux-thumb-wrap contains-addto ">    <span class="video-thumb  yt-thumb yt-thumb-120">
                            <span class="yt-thumb-default">
                                <span class="yt-thumb-clip">
                                <span class="yt-thumb-clip-inner">
                                    <img alt="" src="/dynamic/thumbs/<?php echo $video['thumbnail']; ?>" data-thumb="/thumbs/" data-group-key="thumb-group-0" width="120">
                                    <span class="vertical-align"></span>
                                </span>
                                </span>
                            </span>
                            </span>
                            <span class="video-time"><?php echo timestamp($video['duration']); ?></span>
                            ...
                            </span><span dir="ltr" class="title"><?php echo $video['title']; ?></span><span class="stat attribution">by <span class="yt-user-name " dir="ltr"><?php echo $video['author']; ?></span></span>    <span class="stat view-count">
